...
public class WeatherLoadTest extends Simulation {
...

    {
        ...
        final ScenarioBuilder scn = scenario("Load Test Forecast Endpoint")
                ...
                .pause(1)  // pause for a second between requests
...
//                        .queryParam("daily", "river_discharge_p75")
        ...
        setUp(scn
                ...
                .assertions(
                        details("99% of requests are successful within 3 seconds").responseTime().percentile(99).lte(3_000),
                        details("95% of requests are successful within 5 seconds").responseTime().percentile(95).lte(5_000)
                );
    }
}
